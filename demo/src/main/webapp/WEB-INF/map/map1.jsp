<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <script type="text/javascript"
            src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c6d0367c97a0e67dbd19abdef9c3067a&libraries=services"></script>
    ...
    <body>
        <div id="app">
            <!-- html 코드는 id가 app인 태그 안에서 작업 -->
             <div>
                <select v-model="selectedCategory" @change="fnPlace();">
            ...
            methods: {
                ...
                clearMarkers : function(){
                    for(let i=0; i<this.markers.length;i++){
                        this.markers[i].setMap(null); // 지도에서 제거
                    }
                    this.markers = [];
                }
            }, // methods
